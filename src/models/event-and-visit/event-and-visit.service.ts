  ...
  async create(data: CreateEventAndVisitDto, createdById: string) {
    return await this.prisma.eventAndVisit.create({
      data: {
        ...
        venue: data.venue,
        partner_representatives: data.partner_representatives as unknown as Prisma.InputJsonValue,
        eaii_representatives: data.eaii_representatives as unknown as Prisma.InputJsonValue,
